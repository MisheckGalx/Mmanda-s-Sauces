...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* DELIVERY BANNER - Corner Message - ORANGE */}
      {showDeliveryBanner && (
        <div className="fixed bottom-6 left-6 z-30 max-w-xs bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 shadow-2xl border border-orange-400/50 animate-pulse">
          <div className="flex justify-between items-start gap-4">
            ...
            <button
              ...
              className="flex-shrink-0 p-1 hover:bg-orange-400/20 rounded-full transition-colors"
            >
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[250px] md:auto-rows-[200px]">
      ...
      <section id="contact" className="min-h-screen py-20 px-4 bg-black">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-16 bg-gradient-to-r from-orange-500/20 to-orange-600/20 rounded-2xl p-8 border-2 border-orange-500/50 hover:border-orange-400 transition-all">
            <div className="flex items-start gap-6">
              <div className="p-4 bg-orange-500 rounded-full flex-shrink-0">
                <MapPin size={32} className="text-white" />
              </div>
              <div className="flex-1">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">📍 Our Location</h3>
                <p className="text-orange-100 text-lg mb-3">
                  <span className="font-semibold">Clayville, South Africa</span>
                </p>
                <p className="text-gray-300 text-base leading-relaxed mb-4">
                  We're based in Clayville and offer free delivery for all orders in and around the area. For bulk orders of 10+ units within a 15km radius, we also provide free delivery AND a 10% discount!
                </p>
                <div className="flex flex-col sm:flex-row gap-4 text-sm text-orange-100">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-orange-400">📦</span>
                    <span>Extended Bulk Delivery</span>
                  </div>
                  <div className="flex items-center gap-2">
          ...
          {/* Delivery Info Box */}
          <div className="mt-12 p-8 bg-gradient-to-r from-green-600/20 to-green-700/20 rounded-2xl border border-green-500/30">
