...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* HERO - Solid Red */}
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-red-600">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto pt-20">
          <div className="inline-flex items-center space-x-2 px-6 py-3 bg-white rounded-full mb-8">
            <Sparkles className="text-red-600" size={20} />
            <span className="text-sm font-bold text-gray-900">🇿🇦 Handcrafted in South Africa</span>
          </div>
          ...
          <p className="text-2xl md:text-3xl text-white mb-8 max-w-2xl mx-auto font-bold">
          ...
          <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto">
            {[
              ...
              <div key={idx} className="p-6 bg-white rounded-3xl border-4 border-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: '🌿', text: '100% Natural', color: 'bg-green-100' },
                  { icon: '🔥', text: 'Bold Flavor', color: 'bg-red-100' },
                  { icon: '🏆', text: 'Award Winning', color: 'bg-yellow-100' },
                  { icon: '🇿🇦', text: 'Proudly SA', color: 'bg-orange-100' }
                ].map((item, idx) => (
                  <div key={idx} className={`flex items-center space-x-3 p-4 ${item.color} border-2 border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition`}>
      ...
      {/* PRODUCTS - Light Gray Background */}
      <section id="products" className="py-32 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {products.map((p) => (
              <div key={p.id} className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border-4 border-gray-100 hover:border-red-600">
                ...
                <div className="p-6">
                  ...
                  <button
                    onClick={() => addToCart(p)}
                    className={`w-full py-4 ${p.bgColor} hover:opacity-90 text-white rounded-2xl font-black shadow-lg hover:shadow-2xl transition-all transform hover:scale-105 flex items-center justify-center space-x-2`}
                  >
