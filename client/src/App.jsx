  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white">
            ...
            <div className="flex items-center space-x-4 cursor-pointer group" onClick={() => scrollTo('home')}>
              <div className="relative">
                ...
                <img 
                  src="/images/logo.png" 
                  alt="Mmanda's Logo" 
                  className="relative w-16 h-16 object-contain transform group-hover:scale-110 transition"
                  onError={(e) => {
                    e.target.style.display = 'none';
                    e.target.nextElementSibling.style.display = 'block';
                  }}
                />
                <div className="relative text-5xl transform group-hover:scale-110 transition hidden">🌶️</div>
              </div>
              <div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative group">
              ...
              <div className="relative p-8 bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 overflow-hidden">
                <img 
                  src="/images/hero/about-bg.jpg" 
                  alt="About Mmanda's" 
                  className="w-full h-80 object-cover rounded-2xl mb-6 transform group-hover:scale-105 transition"
                  onError={(e) => {
                    e.target.style.display = 'none';
                    e.target.nextElementSibling.style.display = 'block';
                  }}
                />
                <div className="text-9xl text-center mb-8 transform group-hover:scale-110 transition hidden">🌶️</div>
                ...
                <div className="relative bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 overflow-hidden group-hover:border-white/30 transition-all duration-500 transform group-hover:-translate-y-2">
                  ...
                  <div className="relative h-64 bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center overflow-hidden">
                    ...
                    <img 
                      src={p.image}
                      alt={p.name}
                      className="relative w-full h-full object-cover transform group-hover:scale-110 transition duration-500"
                      onError={(e) => {
                        e.target.style.display = 'none';
                        e.target.nextElementSibling.style.display = 'block';
                      }}
                    />
                    <div className="hidden text-8xl transform group-hover:scale-125 group-hover:rotate-12 transition duration-500">
                      {p.emoji}
                    </div>
                  </div>
      ...
      <section id="gallery" className="py-32 px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-block px-4 py-2 bg-gradient-to-r from-yellow-500/20 to-red-500/20 rounded-full border border-yellow-500/30 mb-6">
              <span className="text-sm font-bold text-yellow-400">LIFESTYLE</span>
            </div>
            <h2 className="text-5xl md:text-6xl font-black mb-4">
            ...
            <p className="text-xl text-gray-400">See how our sauces elevate every meal</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[1, 2, 3].map((num) => (
              <div 
                key={num}
                className="group relative overflow-hidden rounded-3xl border border-white/10 hover:border-white/30 transition-all"
              >
                <img 
                ...
                />
                <div className="hidden w-full h-96 bg-gradient-to-br from-gray-800 to-gray-900 items-center justify-center text-6xl">
                  🌶️
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-end p-6">
                  <p className="text-white font-bold text-lg">Mmanda's in Action</p>
                </div>
              </div>
            ))}
          </div>
