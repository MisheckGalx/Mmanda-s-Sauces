      ...
      <section id="contact" className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* ── Location Card ── */}
            <div className="group p-8 bg-white rounded-2xl transition-all duration-300 hover:shadow-lg text-center border border-gray-200">
              <div className="inline-flex p-4 bg-blue-500 rounded-full mb-4 group-hover:scale-110 transition-transform">
              ...
              <div className="text-base font-semibold text-black">Olifantsfontein</div>
              <div className="text-sm text-gray-500">Gauteng, South Africa</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-3 mb-3">
            <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-orange-500 flex-shrink-0">
              ...
              />
              <div className="text-xl hidden w-full h-full bg-orange-500 items-center justify-center">🌶️</div>
            </div>
