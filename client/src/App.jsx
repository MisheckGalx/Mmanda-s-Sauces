        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              />
              <div className="hidden w-full h-96 bg-orange-500 rounded-2xl items-center justify-center text-9xl text-white">
                🌶️
              </div>
            </div>
      ...
      <section id="gallery" className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">See how our sauces elevate every meal</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[1, 2, 3].map((num) => (
              ...
              >
                ...
                />
                <div className="hidden w-full h-96 bg-orange-500 items-center justify-center text-8xl text-white">
                  🌶️
                </div>
              </div>
            ))}
